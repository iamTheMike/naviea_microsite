...
export default function Home() {
  ...
  const elementPage = () => {
    switch (page) {
      case 0:
        return (
          <Box className="h-full p-10 flex flex-col justify-center items-center overflow-hidden">
            <Image
              src={LOGO.src}
              alt="Nescafe"
              width={150}
      ...
      case 1:
        return (
          <Box className="h-full p-5 flex flex-col justify-between items-center overflow-hidden  ">
            <Wish
      ...
      case 2:
        return (
          <Box className="h-full p-5 flex flex-col justify-between overflow-hidden ">
            <WishResult
